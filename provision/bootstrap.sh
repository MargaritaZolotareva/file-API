...
echo "# bootstrap.sql #"
mysql < resources/sql/bootstrap.sql -u root -p1234
echo "# datadefinition.sql #"
mysql < resources/sql/datadefinition.sql -u root -p1234
echo "# datamanipulation.sql #"
mysql < resources/sql/datamanipulation.sql -u root -p1234
